...
export class Nodejs1693824629761 implements MigrationInterface {
    name = 'Nodejs1693824629761'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`asset\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`serial\` varchar(255) NOT NULL, \`type\` enum ('Stationary', 'Nonstationary', 'Other') NOT NULL, \`status\` enum ('Ready to Deploy', 'Deployed', 'Error') NOT NULL, \`description\` text NULL, \`categoryAssetId\` varchar(255) NOT NULL, \`isDeleted\` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX \`IDX_97722584aab48508512c63aae5\` (\`serial\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
